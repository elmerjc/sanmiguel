 ...
 */
$style = $shape = $color = $size = $custom_background = $custom_text = $align = $link = $title = $sub_title = $button_block = $el_class = $outline_custom_color = $outline_custom_hover_background =
...
if( $sub_title ){
	$title .= '<small>' . esc_html( $sub_title ) . '</small>';
}
