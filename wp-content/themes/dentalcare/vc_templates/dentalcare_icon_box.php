...
<?php if( $box_style == 'style_1' ) : ?>
	...
	<?php if( $style == 'icon_left' ){ ?>
		<div class="icon_box<?php echo esc_attr( $css_class ); ?> <?php echo esc_attr( $style ); ?> clearfix">
			<?php if( $icon ){ ?>
				<div class="icon<?php echo esc_attr($icon_class); ?>"<?php echo esc_attr($icon_style); ?>><i style="font-size:<?php echo esc_attr( $icon_size ); ?>px" class="<?php echo esc_attr( $icon ); ?>"></i></div>
			<?php } ?>
			<div class="icon_text">
				<?php if ( $title ) { ?>
					<h5<?php echo esc_attr($title_style); ?><?php echo esc_attr($title_class); ?>><?php echo wp_kses( $title, array( 'br' => array() ) ); ?></h5>
				<?php } ?>
	...
	<?php }else{ ?>
		<div class="icon_box<?php echo esc_attr( $css_class ); ?> <?php echo esc_attr( $style ); ?> clearfix">
			...
			<div class="icon_text">
				<?php if ( $title ) { ?>
					<h4<?php echo esc_attr($title_style); ?><?php echo esc_attr($title_class); ?>><?php echo wp_kses( $title, array( 'br' => array() ) ); ?></h4>
				<?php } ?>
				<?php echo wpb_js_remove_wpautop( $content, true ); ?>
			</div>
		</div>
