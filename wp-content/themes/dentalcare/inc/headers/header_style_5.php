...
<?php $stickyclass = '';
			...
			<header class="tt-header index3header index5 <?php echo esc_attr($stickyclass); ?>">
				...
				<div class="container">
					<div class="top-inner clearfix">
						...
						$logo = get_template_directory_uri() .'/assets/images/tmp/logo_default.png';
							if ( isset( $dentalcare_option['logo_header_three']['url'] )):
							?>
							<a class="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( $dentalcare_option['logo_header_three']['url'] ); ?>"  alt="<?php bloginfo( 'name' ); ?>" /></a>
							<?php elseif( $logo ) : 
							?>
