...
<?php $stickyclass = '';
			...
			<header class="tt-header index4header positionRelative <?php echo esc_attr($stickyclass); ?>">
						...
						<div class="container">
							<div class="top-line-inner clearfix">
								<div class="top-line-left">
									...
									<?php endif; ?>	
									<?php if(isset($dentalcare_option['topbar_phone'])): ?>
										<?php if(isset($dentalcare_option['topbar_phoneText'])): ?>
											<div class="top-info"><?php echo esc_html( $dentalcare_option['topbar_phoneText'] ); ?> <a href="<?php echo esc_html__('tel:','dentalcare'); echo esc_attr($dentalcare_option['topbar_phone']);?>"><?php echo esc_html( $dentalcare_option['topbar_phone'] ); ?></a></div>
										<?php endif; ?>	
									<?php endif; ?>	
								</div>
								<?php if( !empty( $dentalcare_option['header_social'] ) && $dentalcare_option['header_social'] == '1'): ?>
				...
				<div class="container">
					<div class="top-inner clearfix">
						<?php	
							...
							if (isset( $dentalcare_option['logo_header_one']['url'] )): ?>
							<a class="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( $dentalcare_option['logo_header_one']['url'] ); ?>"  alt="<?php bloginfo( 'name' ); ?>" /></a>
							<?php elseif( $logo ) : 
							?>
